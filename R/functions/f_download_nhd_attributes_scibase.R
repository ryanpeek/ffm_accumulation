## Script name:  Get Sciencebase data for NHDplus Accmumulated Attributes
## Purpose of script: Automated retrieval of the ScienceBase Item:
...
## by: Wieczorek, Jackson and Schwarz, 2018. https://doi.org/10.5066/P9PA63SM.
## adapted from code by: Matthew J Cashman (mcashman@usgs.gov)


f_download_nhd_attributs_scibase <- function(download_dir = "/Volumes/GENOMICS/",
                                             parent_fold = "NHDplus_Accumulated_attributes",
                                             doi = '10.5066/F7765D7V'){
  # Where locally you want to download the data to and create the folder structure
  download_dir <- download_dir
  # Name of the parent folder to hold the data
  parent_folder <- parent_fold
  starting_doi <- doi # Only the DOI number after https://doi.org/ or doi
